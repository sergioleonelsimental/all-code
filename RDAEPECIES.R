...
env.pars <- cbind(envcli.pars, envgeo.pars )
anova.cca(rda(spe.hel, envsue.pars, env.pars), step=10000)

# Test of fraction [a]
anova.cca(rda(spe.hel,envsue.pars,env.pars ), step=1000)
# Test of fraction [c]
anova.cca(rda(spe.hel, envcli.pars, envsue.pars), step=1000)
anova.cca(rda(spe.hel, envgeo.pars, envcli.pars), step=1000)
anova.cca(rda(spe.hel, envgeo.pars, envsue.pars), step=1000)
